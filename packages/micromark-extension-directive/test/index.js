...
test('micromark-extension-directive (core)', async (t) => {
...
test('micromark-extension-directive (syntax, text)', async (t) => {
  await t.test(
  ...
  await t.test('should not support a directive after a colon', async () => {
  ...
  await t.test('should support a colon followed by a letter', async () => {
    assert.equal(micromark(':a', options()), '<p></p>')
  })

  await t.test('should support a colon followed by a digit', async () => {
  ...
  await t.test('should not support a colon followed by a dash', async () => {
    assert.equal(micromark(':-', options()), '<p>:-</p>')
  })
  ...
  await t.test('should support a digit in a name', async () => {
    assert.equal(micromark(':a9', options()), '<p></p>')
  })

  await t.test('should support a dash in a name', async () => {
    assert.equal(micromark(':a-b', options()), '<p></p>')
  })

  await t.test('should *not* support a dash at the end of a name', async () => {
    assert.equal(micromark(':a-', options()), '<p>:a-</p>')
  })

  await t.test('should support an underscore in a name', async () => {
  ...
  await t.test('should *not* support a colon right after a name', async () => {
    assert.equal(micromark(':a:', options()), '<p>:a:</p>')
  })

  await t.test('should not interfere w/ gemoji (1)', async () => {
    assert.equal(micromark(':+1:', options()), '<p>:+1:</p>')
  })

  await t.test('should not interfere w/ gemoji (2)', async () => {
    assert.equal(micromark(':heart:', options()), '<p>:heart:</p>')
  })

  await t.test('should not interfere w/ gemoji (3)', async () => {
    assert.equal(
  ...
  await t.test('should not interfere w/ emphasis (`_`)', async () => {
    assert.equal(
  ...
  await t.test('should support an empty label', async () => {
    assert.equal(micromark(':a[]', options()), '<p></p>')
  })

  await t.test('should support a whitespace only label', async () => {
    assert.equal(micromark(':a[ \t]', options()), '<p></p>')
  })

  await t.test('should support an eol in a label', async () => {
    assert.equal(micromark(':a[\n]', options()), '<p></p>')
  })

  await t.test('should support content in a label', async () => {
    assert.equal(micromark(':a[a b c]asd', options()), '<p>asd</p>')
  })

  await t.test('should support markdown in a label', async () => {
    assert.equal(micromark(':a[a *b* c]asd', options()), '<p>asd</p>')
  })
  ...
  await t.test('should support markdown in a label (hard break)', async () => {
    assert.equal(
      micromark(':x[a  \nb]c', options({'*': h})),
      '<p><x>a<br />\nb</x>c</p>'
    )
  ...
  await t.test('should support a directive in a label', async () => {
    assert.equal(micromark('a :b[c :d[e] f] g', options()), '<p>a  g</p>')
  })

  await t.test('should support content after a label', async () => {
    assert.equal(micromark(':a[]asd', options()), '<p>asd</p>')
  })

  await t.test('should support empty attributes', async () => {
    assert.equal(micromark(':a{}', options()), '<p></p>')
  })

  await t.test('should support whitespace only attributes', async () => {
    assert.equal(micromark(':a{ \t}', options()), '<p></p>')
  })

  await t.test('should support an eol in attributes', async () => {
    assert.equal(micromark(':a{\n}', options()), '<p></p>')
  })

  await t.test('should support attributes w/o values', async () => {
    assert.equal(micromark(':a{a b c}', options()), '<p></p>')
  })

  await t.test('should support attributes w/ non-ascii letters', async () => {
    assert.equal(
  ...
  await t.test('should support attributes w/ unquoted values', async () => {
    assert.equal(micromark(':a{a=b c=d}', options()), '<p></p>')
  })

  await t.test('should support attributes w/ class shortcut', async () => {
  ...
  await t.test('should support attributes w/ id shortcut', async () => {
    assert.equal(micromark(':a{#a #b}', options()), '<p></p>')
  })
  ...
  await t.test('should not support an empty shortcut (`.`)', async () => {
    assert.equal(micromark(':a{..b}', options()), '<p>{..b}</p>')
  })
  ...
  await t.test('should support non-ascii characters in shortcuts', async () => {
    assert.equal(micromark(':a{#بلوتو}', options()), '<p></p>')
  })

  await t.test('should support most characters in shortcuts', async () => {
    assert.equal(micromark(':a{.a💚b}', options()), '<p></p>')
  })

  await t.test('should support an underscore in attribute names', async () => {
    assert.equal(micromark(':a{_}', options()), '<p></p>')
  })

  await t.test('should support a colon in attribute names', async () => {
    assert.equal(micromark(':a{xml:lang}', options()), '<p></p>')
  })

  await t.test('should support double quoted attributes', async () => {
    assert.equal(micromark(':a{a="b" c="d e f"}', options()), '<p></p>')
  })

  await t.test('should support single quoted attributes', async () => {
    assert.equal(micromark(":a{a='b' c='d e f'}", options()), '<p></p>')
  })

  await t.test('should support whitespace around initializers', async () => {
    assert.equal(
  ...
  await t.test('should support EOLs in quoted attribute values', async () => {
...
test('micromark-extension-directive (syntax, leaf)', async (t) => {
  await t.test('should support a directive', async () => {
    assert.equal(micromark('::b', options()), '')
  })

  await t.test('should not support one colon', async () => {
    assert.equal(micromark(':', options()), '<p>:</p>')
  })
  ...
  await t.test('should support two colons followed by a letter', async () => {
    assert.equal(micromark('::a', options()), '')
  })

  await t.test('should support two colons followed by a digit', async () => {
  ...
  await t.test('should not support two colons followed by a dash', async () => {
    assert.equal(micromark('::-', options()), '<p>::-</p>')
  })
  ...
  await t.test('should not support an eol in a label', async () => {
    assert.equal(micromark('::a[\n]', options()), '<p>::a[\n]</p>')
  })
  ...
  await t.test('should not support content after a label', async () => {
  ...
  await t.test('should not support an eol in attributes', async () => {
    assert.equal(micromark('::a{\n}', options()), '<p>::a{\n}</p>')
  })
  ...
  await t.test('should not support EOLs around initializers', async () => {
  ...
  await t.test('should support whitespace after directives', async () => {
    assert.equal(micromark('::a{b=c} \t ', options()), '')
  })

  await t.test('should support a block quote after a leaf', async () => {
    assert.equal(
      micromark('::a{b=c}\n>a', options()),
      '<blockquote>\n<p>a</p>\n</blockquote>'
    )
  ...
  await t.test('should support code (fenced) after a leaf', async () => {
    assert.equal(
      micromark('::a{b=c}\n```js\na', options()),
  ...
  await t.test('should support code (indented) after a leaf', async () => {
    assert.equal(
      micromark('::a{b=c}\n    a', options()),
      '<pre><code>a\n</code></pre>'
    )
  ...
  await t.test('should support a definition after a leaf', async () => {
    assert.equal(micromark('::a{b=c}\n[a]: b', options()), '')
  })

  await t.test('should support a heading (atx) after a leaf', async () => {
    assert.equal(micromark('::a{b=c}\n# a', options()), '<h1>a</h1>')
  })

  await t.test('should support a heading (setext) after a leaf', async () => {
    assert.equal(micromark('::a{b=c}\na\n=', options()), '<h1>a</h1>')
  })

  await t.test('should support html after a leaf', async () => {
    assert.equal(micromark('::a{b=c}\n<!-->', options()), '<!-->')
  })

  await t.test('should support a list after a leaf', async () => {
    assert.equal(
      micromark('::a{b=c}\n* a', options()),
      '<ul>\n<li>a</li>\n</ul>'
    )
  ...
  await t.test('should support a paragraph after a leaf', async () => {
    assert.equal(micromark('::a{b=c}\na', options()), '<p>a</p>')
  })

  await t.test('should support a thematic break after a leaf', async () => {
    assert.equal(micromark('::a{b=c}\n***', options()), '<hr />')
  })

  await t.test('should support a block quote before a leaf', async () => {
    assert.equal(
      micromark('>a\n::a{b=c}', options()),
      '<blockquote>\n<p>a</p>\n</blockquote>\n'
    )
  ...
  await t.test('should support code (fenced) before a leaf', async () => {
    assert.equal(
      micromark('```js\na\n```\n::a{b=c}', options()),
      '<pre><code class="language-js">a\n</code></pre>\n'
    )
  ...
  await t.test('should support code (indented) before a leaf', async () => {
    assert.equal(
      micromark('    a\n::a{b=c}', options()),
      '<pre><code>a\n</code></pre>\n'
    )
  ...
  await t.test('should support a definition before a leaf', async () => {
    assert.equal(micromark('[a]: b\n::a{b=c}', options()), '')
  })

  await t.test('should support a heading (atx) before a leaf', async () => {
    assert.equal(micromark('# a\n::a{b=c}', options()), '<h1>a</h1>\n')
  })

  await t.test('should support a heading (setext) before a leaf', async () => {
    assert.equal(micromark('a\n=\n::a{b=c}', options()), '<h1>a</h1>\n')
  })

  await t.test('should support html before a leaf', async () => {
    assert.equal(micromark('<!-->\n::a{b=c}', options()), '<!-->\n')
  })

  await t.test('should support a list before a leaf', async () => {
    assert.equal(
      micromark('* a\n::a{b=c}', options()),
      '<ul>\n<li>a</li>\n</ul>\n'
    )
  ...
  await t.test('should support a paragraph before a leaf', async () => {
    assert.equal(micromark('a\n::a{b=c}', options()), '<p>a</p>\n')
  })

  await t.test('should support a thematic break before a leaf', async () => {
    assert.equal(micromark('***\n::a{b=c}', options()), '<hr />\n')
  })

  await t.test('should not support lazyness (1)', async () => {
    assert.equal(
      micromark('> ::a\nb', options({'*': h})),
      '<blockquote><a></a>\n</blockquote>\n<p>b</p>'
    )
  ...
  await t.test('should not support lazyness (2)', async () => {
    assert.equal(
      micromark('> a\n::b', options({'*': h})),
      '<blockquote>\n<p>a</p>\n</blockquote>\n<b></b>'
    )
...
test('micromark-extension-directive (syntax, container)', async (t) => {
  await t.test('should support a directive', async () => {
    assert.equal(micromark(':::b', options()), '')
  })
  ...
  await t.test('should support three colons followed by a letter', async () => {
    assert.equal(micromark(':::a', options()), '')
  })

  await t.test('should support three colons followed by a digit', async () => {
    assert.equal(micromark(':::9', options()), '')
  })
  ...
  await t.test('should support no closing fence', async () => {
    assert.equal(micromark(':::a\n', options()), '')
  })
  ...
  await t.test('should support no closing fence in a list (1)', async () => {
    assert.equal(
      micromark('* :::directive', options()),
      '<ul>\n<li></li>\n</ul>'
    )
  ...
  await t.test('should support no closing fence in a list (2)', async () => {
    assert.equal(
      micromark('* :::directive\n  \n', options()),
      '<ul>\n<li></li>\n</ul>'
    )
  ...
  await t.test('should support no closing fence in a list (3)', async () => {
    assert.equal(
      micromark('* :::directive\n  asd\n', options()),
      '<ul>\n<li></li>\n</ul>'
    )
  ...
  await t.test('should support no closing fence in a list (4)', async () => {
    assert.equal(
      micromark('* :::directive\n  \n\nasd', options()),
      '<ul>\n<li></li>\n</ul>\n<p>asd</p>'
    )
  ...
  await t.test('should support an immediate closing fence', async () => {
    assert.equal(micromark(':::a\n:::', options()), '')
  })

  await t.test('should support content after a closing fence', async () => {
    assert.equal(micromark(':::a\n:::\nb', options()), '<p>b</p>')
  })
  ...
  await t.test('should close w/ a closing fence of more colons', async () => {
    assert.equal(micromark(':::a\n::::\nb', options()), '<p>b</p>')
  })

  await t.test('should support more opening colons', async () => {
    assert.equal(micromark('::::a\n::::\nb', options()), '<p>b</p>')
  })
  ...
  await t.test('should close w/ an indented closing fence', async () => {
    assert.equal(micromark(':::a\n  :::\nc', options()), '<p>c</p>')
  })
  ...
  await t.test('should support blank lines in content', async () => {
    assert.equal(micromark(':::a\n\n  \n\ta', options()), '')
  })

  await t.test('should support an EOL EOF', async () => {
    assert.equal(micromark(':::a\n\ta\n', options()), '')
  })

  await t.test('should support an indented directive', async () => {
    assert.equal(micromark('  :::a\n  b\n  :::\nc', options()), '<p>c</p>')
  })
  ...
  await t.test('should support a block quote after a container', async () => {
    assert.equal(
      micromark(':::a\n:::\n>a', options()),
      '<blockquote>\n<p>a</p>\n</blockquote>'
    )
  ...
  await t.test('should support code (fenced) after a container', async () => {
    assert.equal(
      micromark(':::a\n:::\n```js\na', options()),
      '<pre><code class="language-js">a\n</code></pre>\n'
    )
  ...
  await t.test('should support code (indented) after a container', async () => {
    assert.equal(
      micromark(':::a\n:::\n    a', options()),
      '<pre><code>a\n</code></pre>'
    )
  ...
  await t.test('should support a definition after a container', async () => {
    assert.equal(micromark(':::a\n:::\n[a]: b', options()), '')
  })

  await t.test('should support a heading (atx) after a container', async () => {
    assert.equal(micromark(':::a\n:::\n# a', options()), '<h1>a</h1>')
  })
  ...
  await t.test('should support html after a container', async () => {
    assert.equal(micromark(':::a\n:::\n<!-->', options()), '<!-->')
  })

  await t.test('should support a list after a container', async () => {
    assert.equal(
      micromark(':::a\n:::\n* a', options()),
      '<ul>\n<li>a</li>\n</ul>'
    )
  ...
  await t.test('should support a paragraph after a container', async () => {
    assert.equal(micromark(':::a\n:::\na', options()), '<p>a</p>')
  })
  ...
  await t.test('should support a block quote before a container', async () => {
    assert.equal(
      micromark('>a\n:::a\nb', options()),
      '<blockquote>\n<p>a</p>\n</blockquote>\n'
    )
  ...
  await t.test('should support code (fenced) before a container', async () => {
    assert.equal(
      micromark('```js\na\n```\n:::a\nb', options()),
      '<pre><code class="language-js">a\n</code></pre>\n'
    )
  ...
  await t.test('should support a definition before a container', async () => {
    assert.equal(micromark('[a]: b\n:::a\nb', options()), '')
  })
  ...
  await t.test('should support html before a container', async () => {
    assert.equal(micromark('<!-->\n:::a\nb', options()), '<!-->\n')
  })

  await t.test('should support a list before a container', async () => {
    assert.equal(
      micromark('* a\n:::a\nb', options()),
      '<ul>\n<li>a</li>\n</ul>\n'
    )
  ...
  await t.test('should support a paragraph before a container', async () => {
    assert.equal(micromark('a\n:::a\nb', options()), '<p>a</p>\n')
  })
  ...
  await t.test('should support prefixed containers (1)', async () => {
    assert.equal(micromark(' :::x\n ', options({'*': h})), '<x></x>')
  })

  await t.test('should support prefixed containers (2)', async () => {
    assert.equal(
      micromark(' :::x\n - a', options({'*': h})),
      '<x>\n<ul>\n<li>a</li>\n</ul>\n</x>'
    )
  ...
  await t.test('should support prefixed containers (3)', async () => {
    assert.equal(
      micromark(' :::x\n - a\n > b', options({'*': h})),
      '<x>\n<ul>\n<li>a</li>\n</ul>\n<blockquote>\n<p>b</p>\n</blockquote>\n</x>'
    )
  ...
  await t.test('should support prefixed containers (4)', async () => {
    assert.equal(
      micromark(' :::x\n - a\n > b\n :::', options({'*': h})),
      '<x>\n<ul>\n<li>a</li>\n</ul>\n<blockquote>\n<p>b</p>\n</blockquote>\n</x>'
    )
  ...
  await t.test('should not support lazyness (3)', async () => {
    assert.equal(
      micromark('> a\n:::b', options({'*': h})),
      '<blockquote>\n<p>a</p>\n</blockquote>\n<b></b>'
    )
  ...
  await t.test('should not support lazyness (4)', async () => {
    assert.equal(
      micromark('> :::a\n:::', options({'*': h})),
      '<blockquote><a></a>\n</blockquote>\n<p>:::</p>'
    )
...
test('micromark-extension-directive (compile)', async (t) => {
  await t.test('should support a directives (abbr)', async () => {
    assert.equal(
      micromark(
        [
          ':abbr',
  ...
  await t.test('should support directives (youtube)', async () => {
    assert.equal(
      micromark(
        [
          'Text:',
  ...
  await t.test('should support fall through directives (`*`)', async () => {
    assert.equal(
...
test('content', async (t) => {
  ...
  await t.test('should support escaped brackets in a label', async () => {
    assert.equal(
      micromark(':abbr[x\\[y\\]z]', options({abbr})),
      '<p><abbr>x[y]z</abbr></p>'
    )
  ...
  await t.test('should support balanced brackets in a label', async () => {
    assert.equal(
      micromark(':abbr[x[y]z]', options({abbr})),
      '<p><abbr>x[y]z</abbr></p>'
    )
  ...
  await t.test('should support EOLs in a label', async () => {
    assert.equal(
      micromark(':abbr[a\nb\rc]', options({abbr})),
      '<p><abbr>a\nb\rc</abbr></p>'
    )
  ...
  await t.test('should support EOLs at the edges of a label (1)', async () => {
    assert.equal(
      micromark(':abbr[\na\r]', options({abbr})),
      '<p><abbr>\na\r</abbr></p>'
    )
  ...
  await t.test('should support EOLs at the edges of a label (2)', async () => {
    assert.equal(
      micromark(':abbr[\n]', options({abbr})),
      '<p><abbr>\n</abbr></p>'
    )
  ...
  await t.test('should support EOLs around nested directives', async () => {
    assert.equal(
      micromark(':abbr[a\n:abbr[b]\nc]', options({abbr})),
      '<p><abbr>a\n<abbr>b</abbr>\nc</abbr></p>'
    )
  ...
  await t.test('should support EOLs inside nested directives (1)', async () => {
    assert.equal(
      micromark(':abbr[:abbr[\n]]', options({abbr})),
      '<p><abbr><abbr>\n</abbr></abbr></p>'
    )
  ...
  await t.test('should support EOLs inside nested directives (2)', async () => {
    assert.equal(
  ...
  await t.test('should support EOLs inside nested directives (3)', async () => {
    assert.equal(
      micromark(':abbr[:abbr[\nb\n]]', options({abbr})),
      '<p><abbr><abbr>\nb\n</abbr></abbr></p>'
    )
  ...
  await t.test('should support EOLs inside nested directives (4)', async () => {
    assert.equal(
      micromark(':abbr[:abbr[\\\n]]', options({abbr})),
      '<p><abbr><abbr><br />\n</abbr></abbr></p>'
    )
  ...
  await t.test('should support EOLs between attributes', async () => {
    assert.equal(
      micromark(':span{a\nb}', options({'*': h})),
      '<p><span a="" b=""></span></p>'
    )
  ...
  await t.test('should support EOLs at the edges of attributes', async () => {
    assert.equal(
      micromark(':span{\na\n}', options({'*': h})),
      '<p><span a=""></span></p>'
    )
  ...
  await t.test('should support EOLs before initializer', async () => {
    assert.equal(
  ...
  await t.test('should support EOLs after initializer', async () => {
    assert.equal(
      micromark(':span{a=\r\nb}', options({'*': h})),
      '<p><span a="b"></span></p>'
    )
  ...
  await t.test('should support `id` shortcuts', async () => {
    assert.equal(
  ...
  await t.test('should support `class` shortcuts', async () => {
    assert.equal(
      micromark(':span{.a.b}', options({'*': h})),
  ...
  await t.test('should support lists in container directives', async () => {
    assert.equal(
      micromark(':::section\n* a\n:::', options({'*': h})),
      '<section>\n<ul>\n<li>a</li>\n</ul>\n</section>'
    )
...
function h(d) {
  ...
  if (!htmlVoidElements.includes(d.name)) {
    this.tag(`</${d.name}>`)
  }
}
